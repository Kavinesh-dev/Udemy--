...
//DISPLAYING ITEMS IN THE MOVEMENTS CONTAINER
function displayItem(items) {
  containerMovements.innerHTML = '';
  items.forEach(function (mov, i) {
    ...
    containerMovements.insertAdjacentHTML('afterbegin', value);
  });
}
displayItem(account1.movements);

//Creating usernames for every account
const creatingUserName = account => {
  account.forEach(acc => {
...
//Updating balance to the balance element
const balance2 = function (value) {
